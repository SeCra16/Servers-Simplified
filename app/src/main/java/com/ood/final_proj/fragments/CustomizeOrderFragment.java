...
import com.ood.final_proj.Data.Decorator;
import com.ood.final_proj.Data.Food;
...
import com.ood.final_proj.commands.AddOrderCommand;
import com.ood.final_proj.adapters.CustomizeItemViewAdapter;
import com.ood.final_proj.orderDatabase;
...
public class CustomizeOrderFragment extends DialogFragment implements View.OnClickListener {
    ...
    public List<MenuItemData> converToMenuItem(String itemName) {
        ...
        String className = "com.ood.final_proj.Data." + itemName.trim();
        try {
    ...
    public void onClick(View v) {
        try {
            ...
            Food food = (Food) Class.forName("com.ood.final_proj.Data." + itemName).newInstance();
            ...
            for (Map.Entry<String, Boolean> entry : toppings.entrySet()) {
                ...
                if (add) {
                    ...
                    food = (Food) Class.forName("com.ood.final_proj.Data." + topping)
